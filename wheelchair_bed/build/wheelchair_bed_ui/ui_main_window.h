...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        view_logging_pub = new QListView(groupBox_12);
        view_logging_pub->setObjectName(QString::fromUtf8("view_logging_pub"));

        gridLayout_3->addWidget(view_logging_pub, 0, 0, 1, 1);

        view_logging_sub = new QListView(groupBox_12);
        view_logging_sub->setObjectName(QString::fromUtf8("view_logging_sub"));

        gridLayout_3->addWidget(view_logging_sub, 1, 0, 1, 1);
        ...
        dock_status->setMinimumSize(QSize(325, 634));
        ...
        l_state = new QLineEdit(frame);
        l_state->setObjectName(QString::fromUtf8("l_state"));

        verticalLayout_3->addWidget(l_state);

        l_speed = new QLineEdit(frame);
        l_speed->setObjectName(QString::fromUtf8("l_speed"));

        verticalLayout_3->addWidget(l_speed);

        l_steer_angle = new QLineEdit(frame);
        l_steer_angle->setObjectName(QString::fromUtf8("l_steer_angle"));

        verticalLayout_3->addWidget(l_steer_angle);

        l_error1 = new QLineEdit(frame);
        l_error1->setObjectName(QString::fromUtf8("l_error1"));

        verticalLayout_3->addWidget(l_error1);

        l_error2 = new QLineEdit(frame);
        l_error2->setObjectName(QString::fromUtf8("l_error2"));

        verticalLayout_3->addWidget(l_error2);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        button_start->setText(QApplication::translate("MainWindowDesign", "start", 0, QApplication::UnicodeUTF8));
