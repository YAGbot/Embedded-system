...
void GU900_Send_DataList(void)
{
	gu900_printf("{\"DataList\":[{\"Ua\":\"%f\",\"Ub\":\"%f\",\"Uc\":\"%f\",\"Ia\":\"%f\",\"Ib\":\"%f\",\"Ic\":\"%f\",\"P\":\"%f\"}],\"DevID\":\"HYHB%4EP-AC\",\"Us\":\"%d\",\"Is\":\"%d\",\"UBB\":\"%d\",\"IBB\":\"%d\"}\n",\
	g_pack1.Ua1,g_pack1.Ub1,g_pack1.Uc1,g_pack1.Ia1,g_pack1.Ib1,g_pack1.Ic1,g_pack1.P1,1,g_ELE_PAM.U0,g_ELE_PAM.I0/10,g_ELE_PAM.UBB,g_ELE_PAM.IBB);
}
